(function() {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/start.js", function(require, exports, module) {
        ...
        var fnStart = function(config, feConfig, beConfig, cookie) {
            ...
            fnLoad(function() {
                if (feConfig.ismobile) {
                    $$util.loadJs($$data.get("config:base") + "mdevp/extensions/mobile-icp-tips/010/mobile-icp-tips.js", function() {
                    ...
                    $$util.loadJs($$data.get("config:base") + "mdevp/extensions/icp-tips/009/icp-tips.js", function() {
                        if (window.changyan.icp !== "break") {
                            require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/extensions.js");
                        }
                        var $$log = require("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/log.js");
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/util/util.js", function(require, exports, module) {
        ...
        exports.UrlSwitchHttps = function(data) {
            ...
            if (typeof data === "object") {
                ...
                console.log("UrlSwitchHttps type error");
                return;
            }
            if (flag) {
                return JSON.parse(str.replace(/http:\/\//g, "//"));
            }
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/config-white-list.js", function(require, exports, module) {
        ...
        var wlist = {
            ...
            beWhiteList: [ "comment_notice", "copyright", "cyan_title", "domain_whitelist", "hot_topic_list", "hot_topic_mode", "show_participation", "login_external_platform", "allow_upload_img", "comment_operation", "use_user_level", "v3_hack", "display_location", "disable_user_photo", "user_portrait_url", "extensions_key", "forum_redirect_open", "comment_user_emoji", "sso", "sso_button_action", "sso_button_action_type", "sso_isv_login", "sso_isv_logout", "sso_isv_userInfo", "sso_login_logo", "sso_login_new_logo", "sso_type", "is_new_cdn", "isv_type" ]
        };
        exports.feWhiteList = _.union(wlist.fbeWhiteList, wlist.feWhiteList);
        exports.beWhiteList = _.union(wlist.fbeWhiteList, wlist.beWhiteList);
    });
            ...
            openLoginDialog: function(tag) {
                ...
                if (window.changyan.loginDialog) {
                    ...
                    if ($$data.get("beConfig:extensions_key").indexOf("v3.2") >= 0) {
                        $$util.loadJs($$data.get("config:base") + "mdevp/extensions/login-dialog/024/login-dialog.js", function() {
                            that.LoginMode(tag);
                        });
                    } else if ($$data.get("beConfig:extensions_key") == "sohu") {
                        var $$ = window.jQuery ? window.jQuery : $;
                        $$("#SOHUCS").trigger("openLoginDialog");
                    } else if ($$data.get("beConfig:extensions_key") == "simple") {
                        if ($$data.get("feConfig:appid") == "cyqvqDTV5") {
                            if (window.parent.Passport.Dialog) {
                                window.parent.Passport.Dialog.show();
                            }
                        } else {
                            $$util.loadJs($$data.get("config:base") + "mdevp/extensions/simple-login-dialog/002/simple-login-dialog.js", function() {
                                that.LoginMode(tag);
                            });
                        }
                    } else {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/src/api/login-platform-mobile.js", function(require, exports, module) {
        ...
        var mobileLogin = {
            ...
            sso: function() {
                window.location.href = $$data.get("beConfig:mobile_isv_login_url") + "?from=" + $$data.get("feConfig:url");
            },
                            ...
                            success: function(data) {
                                $$user.getUserInfo(function(info) {
                                    if ($$data.get("beConfig:forum_redirect_open") == 1) {
                                        $.ajax({
                                            url: "http://changyan.sohu.com/api/3/user/redirectKuaizhan",
                                            data: {
    ...
    define("/opt/jenkins/workspace/changyan-fe-frontend-v3/version/extensions.json.js", function(require, exports, module) {
        module.exports = {
            ...
            17173: "cy-skin/003/cy-skin.js,cmt-header/033/cmt-header.js,cmt-box/022/cmt-box.js,cmt-list/025/cmt-list.js,cmt-footer/023/cmt-footer.js,hot-topic/015/hot-topic.js,face/007/face.js,cmt-float-bar/018/cmt-float-bar.js,cy-user-page/018/cy-user-page.js,cy-user-info/025/cy-user-info.js,cy-user-avatar/010/cy-user-avatar.js,cy-user-view/014/cy-user-view.js,cy-user-task/016/cy-user-task.js,cy-user-footprint/004/cy-user-footprint.js,cy-user-mall/006/cy-user-mall.js,cy-prop/035/cy-prop.js,cy-report/009/cy-report.js,cy-user-notice/024/cy-user-notice.js,cy-user-feedback/033/cy-user-feedback.js,cmt-notice/016/cmt-notice.js,cy-grade/005/cy-grade.js,cy-score/003/cy-score.js,jump-url/005/jump-url.js,disable-user-photo/005/disable-user-photo.js,cy-auto-recommand/003/cy-auto-recommand.js,http://ue.17173cdn.com/a/lib/chanyan/passport.js",
            ...
            "v3.2": "cy-skin/024/cy-skin.js,cmt-header/062/cmt-header.js,cmt-box/051/cmt-box.js,cmt-list/045/cmt-list.js,cy-av/018/cy-av.js,cmt-footer/035/cmt-footer.js,hot-topic/018/hot-topic.js,face/012/face.js,cmt-float-bar/029/cmt-float-bar.js,cy-user-page/028/cy-user-page.js,cy-user-info/047/cy-user-info.js,cy-user-avatar/014/cy-user-avatar.js,cy-user-view/022/cy-user-view.js,cy-user-footprint/014/cy-user-footprint.js,cy-report/014/cy-report.js,cy-user-notice/045/cy-user-notice.js,cy-user-feedback/047/cy-user-feedback.js,cy-user-set/007/cy-user-set.js,cmt-notice-no-task-msg/007/cmt-notice-no-task-msg.js,cy-grade/008/cy-grade.js,cy-score/006/cy-score.js,jump-url/008/jump-url.js,disable-user-photo/007/disable-user-photo.js,sohu-treaty/007/sohu-treaty.js,cy-auto-recommand/005/cy-auto-recommand.js,phone-verify/004/phone-verify.js,first-login-prompt/003/first-login-prompt.js",
            "17173-v3.2": "cy-skin/024/cy-skin.js,cmt-header/062/cmt-header.js,cmt-box/051/cmt-box.js,cmt-list/045/cmt-list.js,cmt-footer/035/cmt-footer.js,hot-topic/018/hot-topic.js,face/012/face.js,cmt-float-bar/029/cmt-float-bar.js,cy-user-page/028/cy-user-page.js,cy-user-info/047/cy-user-info.js,cy-user-avatar/014/cy-user-avatar.js,cy-user-view/022/cy-user-view.js,cy-user-task/030/cy-user-task.js,cy-user-footprint/014/cy-user-footprint.js,cy-prop/048/cy-prop.js,cy-report/014/cy-report.js,cy-user-notice/045/cy-user-notice.js,cy-user-feedback/047/cy-user-feedback.js,cy-user-set/007/cy-user-set.js,cmt-notice/021/cmt-notice.js,cy-grade/008/cy-grade.js,cy-score/006/cy-score.js,jump-url/008/jump-url.js,disable-user-photo/007/disable-user-photo.js,cy-auto-recommand/005/cy-auto-recommand.js,first-login-prompt/003/first-login-prompt.js,http://ue.17173cdn.com/a/lib/chanyan/passport.js",
            "prop-v3.2": "cy-skin/024/cy-skin.js,cmt-header/062/cmt-header.js,cmt-box/051/cmt-box.js,cmt-list/045/cmt-list.js,cy-av/018/cy-av.js,cmt-footer/035/cmt-footer.js,hot-topic/018/hot-topic.js,face/012/face.js,cmt-float-bar/029/cmt-float-bar.js,cy-user-page/028/cy-user-page.js,cy-user-info/047/cy-user-info.js,cy-user-avatar/014/cy-user-avatar.js,cy-user-view/022/cy-user-view.js,cy-user-task/030/cy-user-task.js,cy-user-footprint/014/cy-user-footprint.js,cy-prop/048/cy-prop.js,cy-report/014/cy-report.js,cy-user-notice/045/cy-user-notice.js,cy-user-feedback/047/cy-user-feedback.js,cy-user-set/007/cy-user-set.js,cmt-notice/021/cmt-notice.js,cy-grade/008/cy-grade.js,cy-score/006/cy-score.js,jump-url/008/jump-url.js,disable-user-photo/007/disable-user-photo.js,sohu-treaty/007/sohu-treaty.js,cy-auto-recommand/005/cy-auto-recommand.js,phone-verify/004/phone-verify.js,first-login-prompt/003/first-login-prompt.js",
            "cyqE875ep-v3.2": "cy-skin/024/cy-skin.js,cmt-header/062/cmt-header.js,cmt-box/051/cmt-box.js,cmt-list/045/cmt-list.js,hot-topic/018/hot-topic.js,cmt-footer/035/cmt-footer.js,face/012/face.js,cmt-float-bar/029/cmt-float-bar.js,cy-report/014/cy-report.js,cy-grade/008/cy-grade.js,cy-score/006/cy-score.js,jump-url/008/jump-url.js,disable-user-photo/007/disable-user-photo.js",
            "wap-prop": "mobile-enter/026/mobile-enter.js,mobile-skin/021/mobile-skin.js,mobile-cmt-box/026/mobile-cmt-box.js,mobile-cmt-header/033/mobile-cmt-header.js,mobile-cmt-list/049/mobile-cmt-list.js,mobile-cy-av/012/mobile-cy-av.js,mobile-login-box/017/mobile-login-box.js,mobile-user-center/036/mobile-user-center.js,mobile-cmt-float-bar/021/mobile-cmt-float-bar.js,mobile-task/013/mobile-task.js,mobile-cmt-barrage/014/mobile-cmt-barrage.js,mobile-auto-recommand/012/mobile-auto-recommand.js",
            sohu: "sohu-cy-skin/011/sohu-cy-skin.js,sohu-cmt-header/013/sohu-cmt-header.js,sohu-cmt-box/019/sohu-cmt-box.js,sohu-cmt-list/008/sohu-cmt-list.js,sohu-cmt-footer/006/sohu-cmt-footer.js,sohu-cy-report/004/sohu-cy-report.js,sohu-jump-url/004/sohu-jump-url.js,sohu-face/003/sohu-face.js,sohu-new-treaty/002/sohu-new-treaty.js",
            test: "mobile-enter/026/mobile-enter.js,mobile-skin/021/mobile-skin.js,mobile-cmt-box/026/mobile-cmt-box.js,mobile-cmt-header/033/mobile-cmt-header.js,mobile-cmt-list/049/mobile-cmt-list.js,mobile-cy-av/012/mobile-cy-av.js,mobile-login-box/017/mobile-login-box.js,mobile-user-center/036/mobile-user-center.js,mobile-cmt-float-bar/021/mobile-cmt-float-bar.js,mobile-task/013/mobile-task.js,mobile-cmt-barrage/014/mobile-cmt-barrage.js,mobile-auto-recommand/012/mobile-auto-recommand.js,mobile-reward/001/mobile-reward.js",
            simple: "simple-cy-skin/002/simple-cy-skin.js,simple-cmt-header/004/simple-cmt-header.js,simple-cmt-box/002/simple-cmt-box.js,simple-cmt-list/001/simple-cmt-list.js,simple-cmt-footer/003/simple-cmt-footer.js,simple-jump-url/001/simple-jump-url.js,simple-cy-report/001/simple-cy-report.js,face/012/face.js,cy-user-page/028/cy-user-page.js,cy-user-info/047/cy-user-info.js,cy-user-avatar/014/cy-user-avatar.js,cy-user-view/022/cy-user-view.js,cy-user-footprint/014/cy-user-footprint.js,cy-user-notice/045/cy-user-notice.js,cy-user-feedback/047/cy-user-feedback.js,cy-user-set/007/cy-user-set.js,cy-auto-recommand/005/cy-auto-recommand.js,phone-verify/004/phone-verify.js,first-login-prompt/003/first-login-prompt.js,http://ue.17173cdn.com/a/lib/chanyan/passport.js"
        };
    });
