...
<%
	...
	try {
		...
		if (jdkVersions.length > 1) {
			...
			if ((jdkMajorVersion == 1 && jdkMinorVersion >= 6) || jdkMajorVersion > 1) {
	...
	try {
		...
		if ((servletMajorVersion == 2 && servletMinorVersion >= 5) || servletMajorVersion > 2) {
...
<body>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2005-2015 shopxx.net All Rights Reserved.</p>
	</div>
</body>
</html>